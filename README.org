...
This extension supplies a few awesome shims to integrate [[https://github.com/meedstrom/org-node][org-node]] with org-roam.
...
Finally, restart Emacs or run =M-x org-node-reset=.  Now org-node's commands should function with minimum surprises.
